...
def mostrar_habitaciones ():
    print("\thabitaciones mascotas:\n")
    print(" "*8+"Columna")



def validar_nom_masc ():
    while True:
...
def validar_cant_dias ():
    while True:
        try:
            cantD = int(input("Ingrese los dias que se alojará su mascota.\n El dia alojado se cobrara 15.000$ : "))
            if cantD >= 1 and cantD <= 30:
                        print("Dias ingresado","=",cantD)
                        acum_total = acum_dias + 15000*cantD
                        return cantD
            else:
                print("DEBE INGRESAR AL MENOS UN DIA !!")
        except:
...
def validar_rut():
    while True:
        try:
            print("Gracias por preferirnos a continuacion una breve encuesta para registrarse: ")
